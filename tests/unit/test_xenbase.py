...
def make_mock_koza_app(name:str, data: Iterable, transform_code: str, map_cache=None, filters=None, translation_table=None):
...
def transform(name :str, data: Iterable, transform_code: str, map_cache=None, filters=None, translation_table=None):
    koza_app = make_mock_koza_app(name, data, transform_code, map_cache=map_cache, filters=filters, translation_table=translation_table)
    set_koza(koza_app)
...
def test_gene_literature_transform():
    row = iter([{'xb_article': 'XB-ART-1', 'pmid': '16938438', 'gene_pages': 'XB-GENEPAGE-487723 nog,XB-GENEPAGE-490377 msx1,XB-GENEPAGE-481828 bmp2,XB-GENEPAGE-483057 bmp4,XB-GENEPAGE-480982 fgf8,XB-GENEPAGE-6045068 hspa1l,XB-GENEPAGE-485625 hsp70'}])
    map_cache = {
        'genepage-2-gene': {
    ...
    entities = transform('gene-literature', row, './examples/xenbase/gene-literature.py', map_cache=map_cache, translation_table=tt)
