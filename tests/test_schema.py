...
from koza.graph_operations.schema import (
    generate_schema_report, write_schema_report_yaml, 
    print_schema_summary, analyze_biolink_compliance
)
    ...
    return {
        ...
        "files": [
            ...
            },
            {
                ...
                "sample_data": [
                    {"subject": "HGNC:123", "predicate": "biolink:related_to", "object": "MONDO:001"}
                ]
            }
        ],
        "column_analysis": {
...
class TestPrintSchemaSummary:
    ...
    def test_print_schema_summary_consistent_schemas(self, capsys):
        ...
        consistent_report = {
            "summary": {
                "nodes": {"file_count": 2, "unique_columns": 4}
            },
            "files": [
    ...
    def test_print_schema_summary_with_multiple_variations(self, capsys):
        ...
        many_variations_report = {
            "summary": {
                "nodes": {"file_count": 5, "unique_columns": 8}
            },
            "files": [
    ...
    def test_print_schema_summary_with_error(self, capsys):
        ...
        error_report = {
            "error": "Failed to analyze schema: No data found"
        }
    ...
    def test_print_schema_summary_missing_summary(self, capsys):
        ...
        incomplete_report = {
            "files": [
                {"filename": "test.tsv", "table_type": "nodes", "column_count": 4}
            ]
        }
...
class TestSchemaIntegration:
    ...
    def test_schema_operations_with_large_data(self, temp_dir):
        ...
        large_report = {
            ...
            "files": [
                {"filename": f"file_{i}.tsv", "table_type": "nodes", "column_count": i % 10 + 3}
                for i in range(100)
            ]
        }
