...
from koza.model.graph_operations import (
    SplitConfig, FileSpec, KGXFormat, KGXFileType, SplitResult
)
...
class TestSplitFilenameGeneration:
    ...
    def test_filename_generation_basic(self, temp_dir):
        ...
        filename = _generate_filename(
            original_path, values_dict, KGXFormat.TSV, remove_prefixes=False
        )
    ...
    def test_filename_generation_with_prefix_removal(self, temp_dir):
        ...
        filename = _generate_filename(
            original_path, values_dict, KGXFormat.JSONL, remove_prefixes=True
        )
    ...
    def test_filename_generation_multiple_values(self, temp_dir):
        ...
        filename = _generate_filename(
            original_path, values_dict, KGXFormat.PARQUET, remove_prefixes=False
        )
...
class TestSplitExportData:
    ...
    def test_export_split_data_tsv(self, mock_db_class):
        ...
        _export_split_data(
            mock_db, "nodes", "category = 'biolink:Gene'", 
            output_path, KGXFormat.TSV
        )
    ...
    def test_export_split_data_jsonl(self, mock_db_class):
        ...
        _export_split_data(
            mock_db, "edges", "source = 'string'", 
            output_path, KGXFormat.JSONL
        )
    ...
    def test_export_split_data_parquet(self, mock_db_class):
        ...
        _export_split_data(
            mock_db, "nodes", "category = 'biolink:Disease'", 
            output_path, KGXFormat.PARQUET
        )
